...
class ViewController: UIViewController , UITableViewDelegate, UITableViewDataSource {
   ...
   let sectionOnecell =  tableView.dequeueReusableCell(withIdentifier: "secondCustomCell", for: indexPath) as! FirstCustomTable
    ...
    override func viewDidLoad() {
        ...
        let nibfooter = UINib(nibName: "MyHeaderFooter", bundle: nil)
        tableView.register(nibfooter, forHeaderFooterViewReuseIdentifier: "MyHeaderFooter")
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let cell = tableView.dequeueReusableHeaderFooterView(withIdentifier: "MyHeaderFooter") as!MyHeaderFooter
        return cell
    }
